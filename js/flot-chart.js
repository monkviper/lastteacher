...
//    graph chart
    ...
    var data = [
        {label: "Correct", data: 50},
        {label: "Incorrect", data: 30},
        {label: "Not Visited", data: 20},
    ];
                ...
                series: {
                    pie: {
                        ...
                        label: {
                            ...
                            radius: 3/4,
                            formatter: function(label, series){
                                return '<div style="font-size:8pt;text-align:center;padding:0px;color:white;">'+label+'<br/>'+ series.percent +'%</div>';
                            },
